...
export const metadata: Metadata = {
  ...
  description: "Три связанных интерактивных курса: основы Go, конкурентность Go и операционные системы. Теория, исполняемые задачи, симуляторы и проверка через go test -race.",
  ...
  openGraph: {
    title: "GraphLMS — лаборатория системного программирования",
    description: "Основы Go, конкурентность и операционные системы: теория, задачи, симуляторы и исполняемая практика.",
    url: "/",
    type: "website",
  },
};
